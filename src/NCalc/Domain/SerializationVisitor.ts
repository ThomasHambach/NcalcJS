import { BinaryExpression, BinaryExpressionType, Identifier, LogicalExpression, LogicalExpressionVisitor, NCalcFunction, TernaryExpression, UnaryExpression, UnaryExpressionType } from '@/NCalc/Domain';
